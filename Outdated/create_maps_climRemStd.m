% Aaron Trefler
% 2016-06-21
% create_climRemMaps: Removes climatology from GRACE values and converts 
% values to standard deviations.
...
%% Convert Values to Standard Deviations
lwe_thickness_climRemStd = lwe_thickness_climRem ./ ...
    repmat(std(lwe_thickness,0, 3),1,1,tps);

%% Adjust Climatology Removed Std Maps
lwe_thickness_climRemStd_adj = adjust_mascon(lwe_thickness_climRemStd);
...
save(save_file,...
    'lwe_thickness_climRemStd',...
    'lwe_thickness_climRemStd_adj',...
    '-append');